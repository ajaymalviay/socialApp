          ...
          DrawerHeader(
            ...
            child: Row(
              children: [
                ...
                getUserData == null || getUserData == "https://alphasocialmedia.productsalphawizz.com/uploads/" ?
                const CircleAvatar(
    ...
    child: Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Image.asset('assets/applogo.png' ,height: 90, width:85,),
            // Text("Alpha Social", style: TextStyle(
